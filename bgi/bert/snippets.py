...
class DataGenerator(object):
    """数据生成器模版
    """
    def __init__(self, data, tokenizer, batch_size=32, buffer_size=None, is_mask=True,
                 rnd = False, rnd_mask_rate=0.15, vocab_size=21128, label_tfidfs=None, add_negative_sample=True, retrain_labels=None, return_center_feature=False):
        self.data = data
        ...
        self.rnd_mask_rate = rnd_mask_rate
        self.vocab_size = vocab_size
        self.label_tfidfs = label_tfidfs
        self.add_negative_sample = add_negative_sample
        self.retrain_labels = retrain_labels
        self.return_center_feature = return_center_feature
...
class Hook:
    ...
    def __getattr__(self, attr):
        """使得 from bert.backend import uniout
