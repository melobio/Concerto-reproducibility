...
from examples.panc8 import tf_utils
...
class GeneEmbedding(tf.keras.layers.Layer):
    ...
    def __init__(self,
        ...
        super(GeneEmbedding, self).__init__(**kwargs)
    ...
    def get_config(self):
        ...
        base_config = super(GeneEmbedding, self).get_config()
    ...
    def build(self, input_shape):
        ...
        seq_length = self._max_sequence_length #dimension_list[1]
        width = self._width #dimension_list[2]
        ...
        super(GeneEmbedding, self).build(input_shape)
    ...
    def call(self, inputs):
        ...
        if self._use_dynamic_slicing:
            ...
            width = self._width #input_shape[2]
            ...
            position_embeddings = self._position_embeddings #tf.expand_dims(self._position_embeddings, axis=0)
